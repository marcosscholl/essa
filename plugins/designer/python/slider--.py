...
class Slider(Widget, QtGui.QSlider):
    ...
    Minimum_Value = QtCore.pyqtProperty(float,fget=getMinimum,fset=setMinimum)     
    def setMaximum(self, value):
        self.setRange(self._min_value, value)
    def getMaximum(self):
        return self._max_value
    Maximum_Value = QtCore.pyqtProperty(float,fget=getMaximum,fset=setMaximum)      
