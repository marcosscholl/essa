# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 17:46:36 2015
...
adaptador = AdapterRange(0,0,display,"value",tagGeradora,"value","t->w")
adaptador.limits(20,40,80,100)
...
AdapterRange(0,"Temperatura",thermo,"value",tagGeradora,"value","t->w")

"""Adaptador que Cria uma Nova Faixa e Adiciona ao Widget LED"""
adaptador2 = AdapterRange(0,0,led,"value",tagGeradora,"value","t->w")
...
tagGera2 = Tag()
adaptador3 = AdapterContinuous(0,0,dial,"value",tagGera2,"value","t->w")
...
adaptador =  AdapterRange(0,True,botao,"state",tagGera2,"provider","w->t")
...
adaptador4 = AdapterRange(0,True,displayStatusTag, "value", tagGera2,"state","t->w")
...
tagPlota = Tag()
adaptador5 = AdapterContinuous(0,0,plota,"value",tagPlota,"value","t->w")
tagPlota._adapter = adaptador5
tagPlota.providerEnable = True
#tagPlota._provider = SineGenerator(1,min=-1,max=1,step=10)
tagPlota._provider = COMM('/dev/ttyACM0',"a:0:i:")
tagPlota._scan = 0.01
"""Adaptador que Conecta Widget Display aos Dados"""
AdapterContinuous(0,0,displayPlota,"value",tagPlota,"value","t->w")
AdapterContinuous(0,0,thermo,"value",tagPlota,"value","t->w")


## TAG 6 ##
"""TAG BOTAO - Desliga o Provedor de Dados do Grafico"""
tagBotaoPlot = Tag(Identity(0,),True,True)
adaptador6 =  AdapterRange(0,True,botaoPlot,"state",tagPlota,"provider","w->t")
