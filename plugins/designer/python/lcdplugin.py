...
from lcd import DisplayLCD


class DisplayLCDPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def __init__(self, parent=None):
        ...
        super(DisplayLCDPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="DisplayLCD" name="displayLCD">\n' \
