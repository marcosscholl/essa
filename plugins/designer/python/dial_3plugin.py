...
from dial_3 import Dial_3


class Dial_3Plugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def __init__(self, parent=None):
        ...
        super(Dial_3Plugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="Dial_3" name="dial_3Widget">\n' \
