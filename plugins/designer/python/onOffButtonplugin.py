...
class OnOffButtonPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def __init__(self, parent=None):
        ...
        super(OnOffButtonPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="OnOffButton" name="onOffButton">\n' \
