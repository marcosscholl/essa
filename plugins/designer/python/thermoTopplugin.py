...
class ThermoTopPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def __init__(self, parent=None):
        ...
        super(ThermoTopPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="ThermoTop" name="thermoTop">\n' \
