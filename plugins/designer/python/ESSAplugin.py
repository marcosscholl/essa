...
class ESSAPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def __init__(self, parent=None):
        ...
        super(ESSAPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="ESSA" name="ESSAWindow">\n' \
               ' <property name="toolTip" >\n' \
               '  <string>ESSA Widget</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis" >\n' \
               '  <string>ESSA SCADA</string>\n' \
               ' </property>\n' \
               '</widget>\n'
